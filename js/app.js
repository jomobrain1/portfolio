export function myapp() {
  ...
  function selectQualification(item) {
    ...
    let $contentActive = document.querySelector(
  ...
  /* PORTFOLIO CAROUSEL */
  const $portfolioCarousel = document.querySelector(
    ".glide.portfolio-carousel"
  );
  ...
  let sectionActive = () => {
    ...
    $sections.forEach((current) => {
      ...
      if (
        $scroll_Y > $sectionTop &&
        $scroll_Y <= $sectionTop + $sectionHeight
      ) {
        document
